...
selectInput(
  "table_bin","Choose whether want National Model (takes really long to run if inlcuded)",
...
### Scatter plot of exposure vs outcome based on input 
...
output$table <- renderTable({
  shiny_input_model(outcome=input$outcome_choice, l_date=input$input_date[1], u_date=input$input_date[2], s_state=input$state_choice, b_nation="nation")
},digits=5)
