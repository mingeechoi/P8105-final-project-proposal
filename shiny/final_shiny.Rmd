...
renderTable({
  if (as.character(input$cov_choice) == "All Interaction/Full Model") {cov_input <- "finances_prop + depression_prop + maskwearing_prop*finances_prop + maskwearing_prop*depression_prop + finances_prop*depression_prop + maskwearing_prop*finances_prop*depression_prop"}
